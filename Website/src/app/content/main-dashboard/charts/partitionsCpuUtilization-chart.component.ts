...
@Component({
    selector: 'partitions-cpu-chart',
    templateUrl: 'partitionsCpuUtilization-chart.component.html'
})
export class PartitionsCpuUtilizationChartComponent {
    ngOnInit() {
        Morris.Area({
            element: 'partitionsCpuUtilizationChart',
            data: [
